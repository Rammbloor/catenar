...
const EN_TRANSLATIONS = {
  ...
  'diagnostics.code.validation_client_stream_static_sequence_required.message':
    'Client-streaming calls require a static request message sequence for Slice 3.2.',
  ...
  'request.shortcut': 'Use {shortcut} inside the editors to run the selected unary, server-streaming or client-streaming method.',
  ...
  'request.unsupported':
    'Slice 3.2 supports unary, server-streaming and client-streaming static sequence methods before widening into bidi streaming.',
  ...
  'workspaceView.copy':
    'Reflection, proto catalogs, unary calls and server streaming share one tighter workspace surface.',
  'workspaceView.eyebrow': 'Slice 3.1',
...
const RU_TRANSLATIONS: Record<TranslationKey, string> = {
  ...
  'diagnostics.code.validation_client_stream_static_sequence_required.message':
    'Для клиентского потока нужна статическая последовательность сообщений запроса в срезе 3.2.',
  ...
  'request.shortcut': 'Используйте {shortcut} в редакторах, чтобы запустить выбранный унарный, серверный или клиентский потоковый метод.',
  ...
  'request.unsupported': 'Срез 3.2 поддерживает унарные, серверные потоковые и клиентские потоковые методы со статической последовательностью перед расширением до bidi streaming.',
  ...
  'workspaceView.copy': 'Server reflection, proto-каталоги, унарные вызовы, серверные потоки и клиентские статические последовательности собраны в единую рабочую область.',
  'workspaceView.eyebrow': 'Slice 3.2',
