...
const (
	...
	MethodWorkspaceClose              BoundMethod = "WorkspaceClose"
	MethodWorkspaceDelete             BoundMethod = "WorkspaceDelete"
	MethodWorkspaceSave               BoundMethod = "WorkspaceSave"
	MethodWorkspaceValidate           BoundMethod = "WorkspaceValidate"
	MethodGitHubWorkspaceLink         BoundMethod = "GitHubWorkspaceLink"
	MethodGitHubWorkspaceStatus       BoundMethod = "GitHubWorkspaceStatus"
	MethodGitHubWorkspacePull         BoundMethod = "GitHubWorkspacePull"
	MethodGitHubWorkspacePush         BoundMethod = "GitHubWorkspacePush"
	MethodGitHubWorkspaceUnlink       BoundMethod = "GitHubWorkspaceUnlink"
	MethodDialogSelectWorkspaceCreate BoundMethod = "DialogSelectWorkspaceCreatePath"
	MethodDialogSelectWorkspaceOpen   BoundMethod = "DialogSelectWorkspaceOpenPath"
	MethodUpdateCheck                 BoundMethod = "UpdateCheck"
	MethodEndpointTest                BoundMethod = "EndpointTest"
	MethodMaterialRegisterFile        BoundMethod = "MaterialRegisterFile"
	...
	MethodDialogSelectProtoFiles      BoundMethod = "DialogSelectProtoFiles"
	MethodDialogSelectProtoDirectory  BoundMethod = "DialogSelectProtoDirectory"
	MethodDialogSelectMaterialFile    BoundMethod = "DialogSelectMaterialFile"
	MethodRequestSave                 BoundMethod = "RequestSave"
	MethodRequestGet                  BoundMethod = "RequestGet"
	MethodRequestDelete               BoundMethod = "RequestDelete"
...
func BuildContractManifest() ContractManifest {
	return ContractManifest{
		...
		BoundMethods: toStrings([]BoundMethod{
			...
			MethodDialogSelectWorkspaceCreate,
			MethodDialogSelectWorkspaceOpen,
			MethodUpdateCheck,
			MethodEndpointTest,
			MethodMaterialRegisterFile,
			MethodCatalogLoadFromReflection,
			MethodCatalogLoadFromProtoSources,
			MethodDialogSelectProtoFiles,
			MethodDialogSelectProtoDirectory,
			MethodDialogSelectMaterialFile,
			MethodRequestSave,
			MethodRequestGet,
			MethodRequestDelete,
